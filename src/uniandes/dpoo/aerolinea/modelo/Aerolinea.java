...
public class Aerolinea
{
    ...
    //new avion (String nombre, int capacidad);
    ...
    Map<String, Ruta> listaRutas = new Map<String, Ruta>();
    
    for (Map.Entry<String, Ruta> pareja: listaRutas.entrySet()) {
    	String Ruta = pareja.getKey();
    	String valor = pareja.getValue();
    	System.out.println("La código de la ruta es: " + Ruta + " y la ruta es: " + valor);
    ...
    {
        this.listaRutas.put( ruta.getCodigoRuta( ), ruta );
    }
